...
# 暱稱
# =========================
nickname_1 = ["星", "月", "白", "夜", "風", "雨", "雪", "海", "雲", "光", "石", "黑", "影", "安", "亮", "微", "極", "孤", "暮", "晚", "晨", "曦", "煙", "浮", "秋", "半", "落", "淺", "涼", "初", "傲", "呆", "貪", "睡", "野", "草", "莓", "芝", "氣", "冰", "脆", "甜", "迷", "搗", "軟", "腹", "幻", "緋", "空", "逆", "琉", "璃", "暗", "羽", "千", "鳴", "蒼", "穹", "讀", "憂", "單", "寂", "暴", "無", "哈", "香", "蕉", "芒", "起", "抹", "茶", "元", "桃", "夢", "惡", "天", "苦", "浪", "佛", "鹹", "純", "熱", "中", "慵", "高", "毒", "瘋", "神", "隱", "魔", "超", "幸", "倒", "悲", "快", "流", "漂", "細", "烈", "寒", "暖", "黎", "黃", "昏", "破", "銀", "宇", "宙", "彗", "恆", "行", "潮", "汐", "浪", "深", "珊", "瑚", "琥", "珀", "翡", "翠", "瑪", "瑙", "珍", "水", "晶", "鑽", "金", "銀", "鐵", "廢", "才", "霸", "渣", "邊", "核", "心", "靈", "魂", "記", "時", "維", "平", "虛", "混", "沌", "秩", "荒", "森", "綠", "洲", "霧", "極", "終", "王", "牌", "傳", "話", "詩", "幽", "妖", "巨", "幼", "叔", "太", "蘿", "少", "御", "王", "騎", "巫", "刺", "忍", "武", "畫", "歌", "舞", "丑", "偵", "怪", "諜", "底", "民", "預", "獵", "狼", "村", "總", "裁", "秘", "助", "導", "演", "編", "劇", "偶", "粉", "黑", "路", "肥", "宅", "文", "憤", "畜", "老", "闆", "員", "主", "客", "新"]
nickname_2 = ["空", "辰", "羽", "語", "夢", "森", "歌", "固", "晨", "霧", "悟", "凸", "詩", "旅", "信", "潮", "泡", "暉", "誌", "流", "鈴", "碎", "片", "軌", "糖", "豚", "熊", "糬", "芙", "貓", "犬", "龍", "丁", "樂", "餅", "凍", "撻", "泥", "獸", "物", "面", "響", "絆", "沫", "極", "章", "序", "狂", "樂", "司", "頭", "包", "賣", "餃", "貼", "堡", "條", "雞", "薩", "麵", "肉", "當", "糰", "鐵", "美", "摩", "卡", "綠", "紅", "烏", "花", "汁", "水", "士", "客", "法", "射", "坦", "輔", "戰", "牧", "雄", "派", "角", "灰", "眾", "鯉", "非", "酋", "皇", "鴿", "鵡", "頭", "鼠", "兔", "狸", "豹", "豚", "鯨", "鯊", "母", "蟹", "蝦", "蝸", "蛙", "龜", "火", "蝶", "蜓", "蜂", "蟻", "蟬", "葉", "枝", "花", "芽", "子", "實", "蔭", "輪", "苔", "蔓", "葦", "公", "岸", "日", "瑰", "合", "薰", "莉", "櫻", "楓", "杏", "林", "蕉", "萍", "藻", "帶", "衣", "菌", "胞", "因", "原", "分", "電", "量", "引", "磁", "虹", "霞", "幕", "雲", "座", "系", "洞", "蟲", "標", "道", "衛", "石", "暴", "電", "嘯", "震", "山", "川", "原", "谷", "溝", "島", "半", "漠", "沙", "丘", "塵", "埃", "粒", "氣", "液", "固", "結", "合", "鋼", "廢", "寶", "琴", "棋", "書", "墨", "硯", "劍", "刀", "槍", "盾", "弓", "箭", "魂", "魄", "痕", "跡", "印", "紋", "章", "符", "咒", "印", "結", "界", "域"]
