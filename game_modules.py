...
def handle_rps_move(user_id, text):
    ...
    if p1_move == p2_move:
        ...
        result_msg += f"👑 恭喜【{p1_name}】贏建立了這場勝利！"
    else:
...
# 100組超強心機詞庫大合集
WORDS_POOL = [
    ("生魚片", "壽司"), ("麥當勞", "肯德基"), ("珍珠奶茶", "牛肉麵"), ("可口可樂", "百事可樂"), ("火鍋", "麻辣燙"), ("滷肉飯", "雞肉飯"), ("漢堡", "三明治"), ("咖啡", "茶"), ("巧克力", "糖果"), ("泡麵", "乾拌麵"),
    ("鋼筆", "鉛筆"), ("口罩", "防毒面具"), ("吉他", "烏克麗麗"), ("鏡子", "玻璃"), ("雨傘", "雨衣"), ("牙刷", "電動牙刷"), ("手機", "平板電腦"), ("耳機", "音響"), ("手錶", "鬧鐘"), ("錢包", "信用卡"),
    ("航海王", "火影忍者"), ("鋼鐵人", "蝙蝠俠"), ("哆啦A夢", "抱抱熊"), ("名偵探柯南", "金田一"), ("蜘蛛人", "蟻人"), ("皮卡丘", "伊布"),
    ("眉毛", "睫毛"), ("班導師", "教官"), ("男朋友", "前男友"), ("班長", "副班長"), ("腳踏車", "摩托車"), ("捷運", "火車"), ("飛機", "直升機"), ("結婚", "訂婚"), ("初戀", "單戀"), ("情敵", "暗戀"),
    ("臉書", "Instagram"), ("LINE", "微信"), ("YouTube", "Netflix"), ("網網紅", "明星"), ("電腦遊戲", "手機遊戲"), ("ChatGPT", "Siri"),
    ("獅子", "老虎"), ("貓咪", "狗狗"), ("海豚", "鯨魚"), ("玫瑰花", "向日葵"), ("香蕉", "芭樂"), ("蘋果", "水梨"),
    ("加班", "熬夜"), ("薪水", "年終獎金"), ("放假", "請假"), ("開會", "報告"),
    ("夜市", "老街"), ("悠遊卡", "一卡通"), ("蝦皮", "淘寶"), ("鹹酥雞", "雞排"), ("珍奶", "黑糖鮮奶"), ("棒球", "壘球"), ("唱歌", "去夜店"), ("看電影", "追劇"), ("泡溫泉", "三溫暖"), ("腳底按摩", "全身Spa"),
    ("護手霜", "乳液"), ("護唇膏", "口紅"), ("隱形眼鏡", "放大片"), ("香水", "體香噴霧"), ("吸管", "環保吸管"), ("拖鞋", "涼鞋"), ("西裝", "襯衫"), ("雨鞋", "布鞋"), ("牙線", "牙籤"), ("指甲剪", "銼刀"),
    ("期末考", "畢業展"), ("寫論文", "做報告"), ("交女朋友", "脫單"), ("教授", "指導教授"), ("退學", "休學"), ("遲到", "請假"), ("創業", "擺攤"), ("中發票", "中樂透"), ("提辭職", "被開除"), ("領紅包", "發紅包"),
    ("芒果", "木瓜"), ("西瓜", "哈密瓜"), ("草莓", "櫻桃"), ("鳳梨酥", "蛋黃酥"), ("甜甜圈", "雞蛋糕"), ("雞排", "豬排"), ("火龍果", "奇異果"), ("地瓜", "馬鈴薯"), ("起司", "奶油"), ("冰淇淋", "霜淇淋"),
    ("鬼滅之刃", "咒術迴戰"), ("進擊的巨人", "東京喰種"), ("火影忍者", "死神"), ("漫威", "DC"), ("演唱會", "音樂祭"), ("Cosplay", "萬聖節變裝"), ("YouTuber", "實況主"), ("周杰倫", "蔡依林"), ("九妹", "館長"), ("五月天", "告五人")
]
...
def handle_undercover_vote(user_id, text):
    ...
    # 🕵️‍♂️ 【臥底偷看密碼】 -> ⚙️ 徹底修復：移除會導致 SyntaxError 的海象地雷行！
    if text == "6688":
    ...
    if not target_name:
        send_message(user_id, f"⚠️ 請輸入你想抓的對象暱稱")
        return True
    if target_name == my_name:
        send_message(user_id, f"⚠️ 不能抓自己啦！")
        return True
    if target_name != partner_name:
        send_message(user_id, f"⚠️ 找不到【{target_name}】的人喔！")
        return True
